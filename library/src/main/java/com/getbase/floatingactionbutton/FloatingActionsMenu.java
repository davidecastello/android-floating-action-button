...
public class FloatingActionsMenu extends ViewGroup {
  ...
  // MOKU MOD: Changed AddFloatingActionButton to FloatingActionButton
  ...
  private void createAddButton(Context context) {
    // MOKU MOD: changed "new AddFloatingActionButton" to "new FloatingActionButton"
    mAddButton = new FloatingActionButton(context) {
      @Override
      void updateBackground() {
        // MOKU MOD: set the FAB Menu icon
  ...
  // MOKU MOD: added methods to add TextView instead of buttons to the menu
  public void addText(TextView textView) {
    addView(textView, mButtonsCount - 1);
    mButtonsCount++;
  }
